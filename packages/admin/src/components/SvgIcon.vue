...
<template>
  <a-space style="vertical-align: text-bottom">
    <icon
    ...
    >
      <template #component>
        ...
        <icon-majest-question-mark-circle-line
          v-if="iconName === 'questionMark'"
        />
        <icon-majest-chevron-left v-if="iconName === 'chevronLeft'" />
        <icon-majest-chevron-right v-if="iconName === 'chevronRight'" />

...
interface IFromOp {
  ...
  inline?: IBasicForm['inline']
  labelPosition?: IBasicForm['labelPosition']
  labelWidth?: IBasicForm['labelWidth']
  labelSize?: IBasicForm['labelSize']
  showBtn?: IBasicForm['showBtn']
  submitBtnText?: IBasicForm['submitBtnText']
  btnPosition?: IBasicForm['btnPosition']
  btnLoading?: IBasicForm['btnLoading']
  modelValue: Record<string, any>
  options: IBasicForm['options']
}

...
import type { TTokenType } from '@/typings/user/user'
import { UserEnum } from '@/enum/userEnum'

function status(type: TTokenType): boolean {
...
function set(type: TTokenType, value: string) {
  if (type === 'token') {

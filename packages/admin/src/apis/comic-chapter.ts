...
export const clearChapterContentsApi = (data: ClearChapterContentsRequest): Promise<ClearChapterContentsResponse> => {
  return httpHandler({
    method: 'POST',
    url: '/api/admin/work/comic-chapter/clear-chapter-contents',
    headers: {
      'Content-Type': 'application/json',
    },
    data,

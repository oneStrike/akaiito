...
/**
 *  接口 [获取验证码](https://apifox.com/apidoc/shared-a9f24650-7b1c-4172-9ff7-bab4a525e590/api-317836341)
 *  @标签 管理端用户模块/获取验证码
 *  @方式 GET
...
/**
 *  接口 [管理员登录](https://apifox.com/apidoc/shared-a9f24650-7b1c-4172-9ff7-bab4a525e590/api-317836342)
 *  @标签 管理端用户模块/管理员登录
 *  @方式 POST
...
/**
 *  接口 [管理员登出](https://apifox.com/apidoc/shared-a9f24650-7b1c-4172-9ff7-bab4a525e590/api-317836343)
 *  @标签 管理端用户模块/管理员登出
 *  @方式 POST
...
/**
 *  接口 [用户注册](https://apifox.com/apidoc/shared-a9f24650-7b1c-4172-9ff7-bab4a525e590/api-317836344)
 *  @标签 管理端用户模块/用户注册
 *  @方式 POST
...
/**
 *  接口 [刷新访问令牌](https://apifox.com/apidoc/shared-a9f24650-7b1c-4172-9ff7-bab4a525e590/api-317836345)
 *  @标签 管理端用户模块/刷新访问令牌
 *  @方式 POST
...
/**
 *  接口 [修改密码](https://apifox.com/apidoc/shared-a9f24650-7b1c-4172-9ff7-bab4a525e590/api-317836346)
 *  @标签 管理端用户模块/修改密码
 *  @方式 POST
...
/**
 *  接口 [更新用户信息](https://apifox.com/apidoc/shared-a9f24650-7b1c-4172-9ff7-bab4a525e590/api-317836347)
 *  @标签 管理端用户模块/更新用户信息
 *  @方式 POST
...
/**
 *  接口 [获取当前用户信息](https://apifox.com/apidoc/shared-a9f24650-7b1c-4172-9ff7-bab4a525e590/api-317836348)
 *  @标签 管理端用户模块/获取当前用户信息
 *  @方式 GET
...
/**
 *  接口 [根据ID获取用户信息](https://apifox.com/apidoc/shared-a9f24650-7b1c-4172-9ff7-bab4a525e590/api-317836349)
...
/**
 *  接口 [获取管理端用户分页列表](https://apifox.com/apidoc/shared-a9f24650-7b1c-4172-9ff7-bab4a525e590/api-317836350)
...
/**
 *  接口 [删除用户](https://apifox.com/apidoc/shared-a9f24650-7b1c-4172-9ff7-bab4a525e590/api-317836351)
 *  @标签 管理端用户模块/删除用户
 *  @方式 POST

 ...
 */
@Module({
  imports: [WorkAuthorModule, WorkCategoryModule, WorkComicModule, WorkComicChapterModule],
  exports: [WorkAuthorModule, WorkCategoryModule, WorkComicModule, WorkComicChapterModule],
})

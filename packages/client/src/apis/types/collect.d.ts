...
export interface ComicsTypesReq {}

/*  */
export type ComicsTypesRes = any
...
export interface BooksTypesReq {}

/*  */
export type BooksTypesRes = any
...
export interface PostsTypesReq {}

/*  */
export type PostsTypesRes = any
